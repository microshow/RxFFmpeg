...
ffmpeg -y -i /storage/emulated/0/1/1.mp4 -loop 1 -framerate 25 -t 3.0 -i /storage/emulated/0/1/1.png -f lavfi -t 3.0 -i anullsrc=channel_layout=stereo:sample_rate=44100 -filter_complex [0:v]scale=iw:ih[outv0];[1:v]scale=iw:ih[outv1];[outv0][outv1]concat=n=2:v=1:a=0:unsafe=1[outv];[0:a][2:a]concat=n=2:v=0:a=1[outa] -map [outv] -map [outa] -r 25 -b 1M -f mp4 -vcodec libx264 -c:a aac -pix_fmt yuv420p -preset superfast /storage/emulated/0/1/result.mp4
